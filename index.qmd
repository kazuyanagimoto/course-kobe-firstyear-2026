...
レポートとスライドのテンプレートを用意しています. 以下からダウンロードして, 中の指示に従って作成してください.

- [レポートのテンプレート](/static/download/template-report.zip)
- [スライドのテンプレート](/static/download/template-slides.zip)
...
- [R](https://www.r-project.org/): データ分析ツール. データ分析の基礎を学ぶ際に使用します.
- [rig](https://github.com/r-lib/rig): Rインストールマネージャ. Rのインストールとバージョン管理に使用します.
